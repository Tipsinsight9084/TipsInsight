...
const teams = ["BP-M",'LS-M','MO-M','OI-M','NSC-M','SB-M','TR-M','WF-M']
...
function MatchForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    const uniqueId = `TH24_${matchNumber}`;
    console.log(formData)

    try {
      console.log({ ...formData, uniqueId })
      const response = await fetch('https://tips-insight-m7y6-backend.vercel.app/create/TH24', {
