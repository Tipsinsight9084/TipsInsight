...
<footer className="footer font-mont bg-customgray p-10 bg-base-200 text-base-content flex md:flex-row flex-col items-center md:my-0 my-4 bg-customgray text-sm md:text-2xl">
  <aside className='basis-2/4 md:my-0 my-10 justify-center'>
