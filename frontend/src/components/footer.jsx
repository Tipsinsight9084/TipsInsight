...
<footer className="footer font-mont bg-customgray p-0 bg-base-200 text-base-content flex md:flex-row flex-col items-center md:my-0 my-1 bg-customgray text-sm md:text-2xl">
